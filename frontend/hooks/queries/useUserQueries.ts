...
export const USER_KEYS = {
  ...
  projectKeys: (connectionId: string) => [...USER_KEYS.all, "projects", connectionId] as const,
  issueKeys: (connectionId: string, projectKey: string) => [...USER_KEYS.all, "issues", connectionId, projectKey] as const,
};
...
export const useLoginMutation = () => {
  ...
  return useMutation({
    mutationFn: (data: AuthenticateUserRequest) => userService.authenticate(data),
    onSuccess: () => {
...
export const useIssueKeysQuery = (connectionId: string | undefined, projectKey: string | undefined) => {
  return useQuery({
...
export const useRefreshDataMutation = () => {
  return useMutation({
    mutationFn: () => userService.refreshData(),
  });
};
