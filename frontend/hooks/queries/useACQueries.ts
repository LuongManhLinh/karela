...
export const AC_KEYS = {
  all: ["ac"] as const,
  acs: (connectionId: string, projectKey: string, storyKey: string) =>
...
export const useACsQuery = (
  connectionId: string | undefined,
  projectKey: string | undefined,
  storyKey: string | undefined
) => {
  return useQuery({
    queryKey: AC_KEYS.acs(connectionId || "", projectKey || "", storyKey || ""),
    queryFn: () =>
      connectionService.getACs(connectionId!, projectKey!, storyKey!),
