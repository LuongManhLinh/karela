...
// Provide mocked defect analysis similar to the Custom UI app's Api.fetchDefectAnalysis
resolver.define("analyzeDefectMockData", async () => {
  return {
    data: {
      notification: "The @forge/ui package is deprecated and MUST NOT be used.",
      report: {
        title: "The @forge/ui package is deprecated and MUST NOT be used.",
        content: `
# Scenario
          ...
          defects: [
            {
              ...
              suggestedImprovements: ["This is a mock suggested improvement."],
            },
          ],
          confidence: 0.75,
        },
...
resolver.define("getAllDefectAnalysisBriefs", async () => {
  const result = await DefectService.getAllAnalysisBriefs();
  return result;
});
