...
import io.ratsnake.integrations.jira.jql.*;
import io.ratsnake.integrations.jira.llm.IssuesGenerateAiAdapter;
...
public class JiraApiService {
    ...
    private final IssuesGenerateAiAdapter issuesGenerateAIService;

    public JiraApiService() {
        this.api = JiraApiFactory.create();
        this.issuesGenerateAIService = new IssuesGenerateAiAdapter(
    ...
    public static void main(String[] args) throws IOException {
        var service = new JiraApiService();
        var r = service.searchIssues(
                Jql.builder()
                        .project("AF")
                        .and()
