...
//	implementation("org.springframework.boot:spring-boot-starter-security")
    ...
    // https://mvnrepository.com/artifact/io.weaviate/client
    implementation("io.weaviate:client:5.4.0")
...
//    implementation("com.atlassian.adf:adf-builder-java-jackson2:1.1.0") // if parsing JSON
    ...
    // https://mvnrepository.com/artifact/io.github.elki-project/elki-core-util
    implementation("io.github.elki-project:elki-core-util:0.8.0")
    // https://mvnrepository.com/artifact/io.github.elki-project/elki-index
    implementation("io.github.elki-project:elki-index:0.8.0")
    // https://mvnrepository.com/artifact/io.github.elki-project/elki-clustering
    implementation("io.github.elki-project:elki-clustering:0.8.0")
